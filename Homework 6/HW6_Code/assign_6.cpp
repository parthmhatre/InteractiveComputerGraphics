...
void read_file ( string FileName) {
    ...
    for (int i=0; i<faces.size(); i++){
        ...
        temp = normalize(cross(temp2, temp1));
...
void normalize_function(){
    ...
    for (int i=0; i<faces.size(); i++){
        ...
        temp_normal1.x = fabs(temp_normal1.x);
        temp_normal1.y = fabs(temp_normal1.y);
        temp_normal1.z = fabs(temp_normal1.z);
        ...
        temp_normal2.x = fabs(temp_normal2.x);
        temp_normal2.y = fabs(temp_normal2.y);
        temp_normal2.z = fabs(temp_normal2.z);
        ...
        temp_normal3.x = fabs(temp_normal3.x);
        temp_normal3.y = fabs(temp_normal3.y);
        temp_normal3.z = fabs(temp_normal3.z);
...
void translate_scale_to_origin(){
    ...
    for(int i=0 ; i<points.size(); i++) {
        ...
        normalized_values[i] = multiply_matrix * normalized_values[i];
    }
}
//----------------------------------------------------------------------------
